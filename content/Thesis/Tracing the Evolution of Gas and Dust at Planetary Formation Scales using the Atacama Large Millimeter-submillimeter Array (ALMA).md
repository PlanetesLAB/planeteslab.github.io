...
Our solar system is sole and closest place to verify and validate our theories on planet formation and for this reason, the importance of solar system science cannot be understated. For instance, [[The History of Solar System|minimum mass solar nebula (MMSN)]] [see @Desch2007 for a review] provides a simple estimate of the mass available in planet forming disks by distributing mass currently held up by solar system planets into concentric touching [[Disk Substructures#Rings|ring]]-like geometries, and then adding volatile elements until the composition becomes *solar*. Variants of MMSN have been proposed by @Weidenschilling1977 [@Hayashi1981; @Crida2009-ef].
